...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        ...
        n_pet_dog = 0.00001
        n_class_cdog = 0.00001
        n_class_cnotd = 0.00001
        n_match_breed = 0.00001
        ...
        print("N Images: {:2d}  N Dog Images: {:2d}  N NotDog Images: {:2d} \nPct Corr dog: {:5.1f} Pct Corr NOTdog: {:5.1f}  Pct Corr Breed: {:5.1f}".format(
             int( results_stats_dic['n_images']), int(results_stats_dic['n_dogs_img']),
              int(results_stats_dic['n_notdogs_img']), int(results_stats_dic['pct_correct_dogs']),
              int(results_stats_dic['pct_correct_notdogs']),
              int(results_stats_dic['pct_correct_breed'])))
        print("\n ** Check Statistics - calculated from this function as a check:")
        print("N Images: {:2d}  N Dog Images: {:2d}  N NotDog Images: {:2d} \nPct Corr dog: {:5.1f} Pct Corr NOTdog: {:5.1f}  Pct Corr Breed: {:5.1f}".format(
              int(n_images),int(n_pet_dog), int(n_pet_notd), pct_corr_dog, pct_corr_notdog,
              pct_corr_breed))
